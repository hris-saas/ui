...
export default function (ctx, inject) {
  ...
  // Register strategies
  // local
  $auth.registerStrategy('local', new scheme_003d9a64($auth, {"endpoints":{"login":{"url":"/login","method":"post","propertyName":"token","withCredentials":true,"headers":{"X-Requested-With":"XMLHttpRequest","Content-Type":"application/json"}},"logout":{"url":"/api/auth/logout","method":"post"},"user":{"url":"/api/user","method":"get","propertyName":false,"withCredentials":true,"headers":{"X-Requested-With":"XMLHttpRequest","Content-Type":"application/json"}}},"tokenRequired":false,"tokenType":false,"_name":"local"}))
